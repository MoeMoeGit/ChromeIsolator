...
> **最后更新**：2026-05-23
> **最后更新人**：Codex
> **最近开发日志**：`06-dev-log.md` 中的 2026-05-23（V1.6.6 最终检查与发布触发）
> **当前可信度**：已复核

## 当前版本

**V1.6.6** — MSI 安装器交互已收口为自定义欢迎页、进度页和完成页，同时固定安装目录到 Program Files，文案与多语言按钮语义已进一步精简。

## 当前阶段

V1.6.6 准备用于触发 GitHub Actions 构建测试包。当前重点是验证安装器 UI 文案、运行中重试和卸载反馈。
...
**已完成**：V1.0.0 全部功能 + V1.1.0 主界面 UI 全面重设计 + V1.1.0 用户测试反馈修复（12 项问题）+ V1.2.0 代码复审修复（5 项问题）+ V1.6.6 MSI 安装 / 卸载反馈收敛。
