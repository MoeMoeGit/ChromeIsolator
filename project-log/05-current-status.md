...
> **最后更新**：2026-05-23
> **最后更新人**：Codex
> **最近开发日志**：`06-dev-log.md` 中的 2026-05-23（设置页帮助更新与语言控件优化）
> **当前可信度**：已复核

## 当前版本

**V1.6.3** — 已优化设置页“帮助与更新”和“语言 / Language”区域：补充作者 Lucas 与联系邮箱，更新入口改为面向普通用户的下载页指引，检查到新版本时显示当前版本、最新版本和安装指引；语言标题保留英文锚点，并统一 ComboBox 外观。

## 当前阶段

V1.6.3 准备用于触发 GitHub Actions 构建测试包。环境卡片宽度问题已在 Windows 实机测试中确认修复成功，本轮继续优化设置页信息架构与控件一致性。
